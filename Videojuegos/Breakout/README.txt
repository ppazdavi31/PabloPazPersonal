...
# 5. Rainbow powerup increases multiplier to x4 for 8 seconds
# 6. Powerup timer resets upon pickup ex: If x4 mult has 1 second remaining and you pick another rainbow ball, the timer resets to 8 seconds
# 7. There are 3 levels, each one increases a block line by 1
# 8. Press R to restart
# 9. Press space to serve the ball
